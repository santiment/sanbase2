...
export const USER_ADD_NEW_ASSET_LIST_SUCCESS = '[user] ADD_NEW_ASSET_LIST_SUCCESS'
export const USER_ADD_NEW_ASSET_LIST_FAILED = '[user] ADD_NEW_ASSET_LIST_FAILED'
export const USER_ADD_NEW_ASSET_LIST_CANCEL = '[user] ADD_NEW_ASSET_LIST_CANCELED'
