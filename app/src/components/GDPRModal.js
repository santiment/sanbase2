    ...
    <Modal.Content>
      <FadeIn duration='0.5s' timingFunction='ease-out' as='div'>
        <Form
          ...
          <p>
            Please accept our updated Privacy Policy by May,
            2018 to continue using Sanbase
          </p>
          <Checkbox
          ...
          <Link onClick={toggleGDPRModal} to='/privacy-policy'>Santiment Privacy Policy</Link>
        </Form>
      </FadeIn>
    </Modal.Content>
    <Modal.Actions>
