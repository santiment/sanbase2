...
config :sanbase, Sanbase.KafkaExporter,
  ...
  asset_price_pairs_only_topic: {:system, "KAFKA_CRYPTOCOMPARE_PRICES_ONLY_TOPIC", "asset_price_pairs_only"},
  asset_ohlcv_price_pairs_topic: {:system, "KAFKA_ASSET_OHLCV_PRICE_POINTS_TOPIC", "asset_ohlcv_price_pairs"},
  open_interest_topic: {:system, "KAFKA_OPEN_INTEREST_TOPIC", "open_interest_cryptocompare"},
  open_interest_topic_v2: {:system, "KAFKA_OPEN_INTEREST_TOPIC_V2", "open_interest_cryptocompare_v2"},
...
config :sanbase, Sanbase.RepoReader, projects_data_endpoint_secret: {:system, "PROJECTS_DATA_ENDPOINT_SECRET"}
config :sanbase, Sanbase.SocialData, metricshub_url: {:system, "METRICS_HUB_URL", "http://metrics-hub-server"}
...
config :sanbase, SanbaseWeb.Endpoint,
  ...
  url: [host: "localhost"],
  secret_key_base: "not_secret_please_do_not_report_Vq7Rfo0T4EfiLX2/ryYal3O0l9ebBNhyh58cfWdTAUHxEJGu2p9u1WTQ31Ki4Phj",
...
config :sanbase, SanbaseWeb.Plug.BotLoginPlug, bot_login_endpoint: {:system, "BOT_LOGIN_SECRET_ENDPOINT"}
