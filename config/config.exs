...
config :ex_admin,
  ...
  modules: [
    ...
    Sanbase.ExAdmin.Model.Btt,
    Sanbase.ExAdmin.Model.Country,
    Sanbase.ExAdmin.Model.Currency,
    Sanbase.ExAdmin.Model.Facebook,
    Sanbase.ExAdmin.Model.Github,
    ...
    Sanbase.ExAdmin.Model.Reddit,
    Sanbase.ExAdmin.Model.TeamMember,
