...
config :ex_admin,
  ...
  modules: [
    ...
    Sanbase.ExAdmin.Widget.ActiveWidget,
    Sanbase.ExAdmin.Chart.Configuration,
    ...
    Sanbase.ExAdmin.Metric.MetricPostgresData,
    Sanbase.ExAdmin.Notifications.Notification,
    Sanbase.ExAdmin.Billing.Plan,
    Sanbase.ExAdmin.SocialData.PopularSearchTerm,
    ...
    Sanbase.ExAdmin.Comments.Notification
  ],
  basic_auth: [
