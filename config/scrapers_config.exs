...
alias Sanbase.Cryptocompare.AddHistoricalJobsWorker
...
config :sanbase, Oban.Scrapers,
  ...
  plugins: [
    ...
    {Oban.Plugins.Cron,
     crontab: [
       {"0 3 * * *", AddHistoricalJobsWorker, args: %{"type" => "schedule_historical_price_jobs"}, max_attempts: 10},
       {"0 * * * *", AddHistoricalJobsWorker,
...
config :sanbase, Sanbase.ExternalServices.Etherscan.Requests, apikey: {:system, "ETHERSCAN_APIKEY", ""}
config :sanbase, Sanbase.Twitter.FollowersScheduler, enabled?: {:system, "TWITTER_FOLLOWERS_SCHEDULER_ENABLED", "false"}
