defmodule Sanbase.Seeds.ExchangeFundsFlowSeed do
  ...
  def populate() do
    changesets = [
      make_changeset("0x123123", random_date(), random_non_neg_float(), random_non_neg_float()),
      make_changeset("0x123123", random_date(), random_non_neg_float(), random_non_neg_float()),
      make_changeset("0x123123", random_date(), random_non_neg_float(), random_non_neg_float()),
      make_changeset("0x123123", random_date(), random_non_neg_float(), random_non_neg_float()),
      make_changeset("0x123123", random_date(), random_non_neg_float(), random_non_neg_float()),
      ...
      make_changeset("0x123123", random_date(), random_non_neg_float(), random_non_neg_float()),
      make_changeset("0x123123", random_date(), random_non_neg_float(), random_non_neg_float()),
      make_changeset("0x543210", random_date(), random_non_neg_float(), random_non_neg_float()),
      make_changeset("0x543210", random_date(), random_non_neg_float(), random_non_neg_float()),
      make_changeset("0x543210", random_date(), random_non_neg_float(), random_non_neg_float()),
      make_changeset("0x543210", random_date(), random_non_neg_float(), random_non_neg_float()),
      make_changeset("0x543210", random_date(), random_non_neg_float(), random_non_neg_float()),
