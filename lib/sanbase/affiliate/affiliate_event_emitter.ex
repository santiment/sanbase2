defmodule Sanbase.Affiliate.EventEmitter do
  ...
  def handle_event({:ok, _promoter}, :create_promoter, %{user: user, promoter_origin: promoter_origin}) do
    notify(%{event_type: :create_promoter, user_id: user.id, promoter_origin: promoter_origin})
  end
