defmodule Sanbase.ExternalServices.IcoSpreadsheet do
  ...
  def get_project_data(document_id, api_key, project_names) when is_list(project_names) do
    IO.puts("Starting ICO spreadsheet fetch...")
    ...
    IO.puts("Finished ICO spreadsheet fetch.")
    ico_spreasheet
  end
  ...
  defp parse_value(value_row, {column, index}, project_name) do
    ...
    case column do
      ...
      c when c in [:tokens_sold_at_ico, :funds_raised_btc, :funds_raised_usd, :funds_raised_eth, :minimal_cap_amount, :maximal_cap_amount] ->
