defmodule Sanbase.Metric.Category do
  ...
  alias Sanbase.Metric.Category.MetricCategoriesMapping
  ...
  """
  @spec get_category_by_slug(String.t()) :: MetricCategory.t() | nil
  def get_category_by_slug(slug), do: MetricCategory.get_by_slug(slug)
  ...
  @doc """
  Gets a metric group by slug and category ID.
  """
  @spec get_group_by_slug_and_category(String.t(), integer()) :: MetricGroup.t() | nil
  def get_group_by_slug_and_category(slug, category_id) do
    MetricGroup.get_by_slug_and_category(slug, category_id)
  end
  ...
  """
  @spec create_group_if_not_exists(String.t(), String.t(), integer()) :: {:ok, MetricGroup.t()}
  def create_group_if_not_exists(name, slug, category_id) do
    MetricGroup.create_if_not_exists(name, slug, category_id)
  end
  ...
  """
  @spec create_mapping(map()) :: {:ok, MetricCategoriesMapping.t()} | {:error, Ecto.Changeset.t()}
  def create_mapping(attrs) do
    MetricCategoriesMapping.create(attrs)
  end

  @doc """
  Updates a metric categories mapping.
  """
  @spec update_mapping(MetricCategoriesMapping.t(), map()) ::
          {:ok, MetricCategoriesMapping.t()} | {:error, Ecto.Changeset.t()}
  def update_mapping(%MetricCategoriesMapping{} = mapping, attrs) do
    MetricCategoriesMapping.update(mapping, attrs)
  end

  @doc """
  Deletes a metric categories mapping.
  """
  @spec delete_mapping(MetricCategoriesMapping.t()) ::
          {:ok, MetricCategoriesMapping.t()} | {:error, Ecto.Changeset.t()}
  def delete_mapping(%MetricCategoriesMapping{} = mapping) do
    MetricCategoriesMapping.delete(mapping)
  end

  @doc """
  Gets mappings by metric registry ID.
  """
  @spec get_mappings_by_metric_registry_id(integer()) :: [MetricCategoriesMapping.t()]
  def get_mappings_by_metric_registry_id(metric_registry_id) do
    MetricCategoriesMapping.get_by_metric_registry_id(metric_registry_id)
  end

  @doc """
  Gets mappings by module and metric.
  """
  @spec get_mappings_by_module_and_metric(String.t(), String.t()) :: [MetricCategoriesMapping.t()]
  def get_mappings_by_module_and_metric(module, metric) do
    MetricCategoriesMapping.get_by_module_and_metric(module, metric)
  end

  @doc """
  Gets mappings by group ID.
  """
  @spec get_mappings_by_group_id(integer()) :: [MetricCategoriesMapping.t()]
  def get_mappings_by_group_id(group_id) do
    MetricCategoriesMapping.get_by_group_id(group_id)
  end
  ...
  def create_mapping_by_metric_registry_id(metric_registry_id, group_id) do
    MetricCategoriesMapping.create_by_metric_registry_id(metric_registry_id, group_id)
  end
  ...
  def create_mapping_by_module_and_metric(module, metric, group_id) do
    MetricCategoriesMapping.create_by_module_and_metric(module, metric, group_id)
  end
  ...
  def create_mapping_if_not_exists(attrs) do
    MetricCategoriesMapping.create_if_not_exists(attrs)
  end
