defmodule Sanbase.Metric.SqlQuery.Helper do
  ...
  def generate_comprasion_string(:less_than_or_equal_to, threshold), do: "<= #{threshold}"
  def generate_comprasion_string(:greater_than, threshold), do: "> #{threshold}"
  def generate_comprasion_string(:greater_than_or_equal_to, threshold), do: ">= #{threshold}"
end
