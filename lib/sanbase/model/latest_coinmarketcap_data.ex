defmodule Sanbase.Model.LatestCoinmarketcapData do
  ...
  def changeset(%LatestCoinmarketcapData{} = latest_coinmarketcap_data, attrs \\ %{}) do
    ...
    |> cast(attrs, [:coinmarketcap_id, :name, :symbol, :price_usd, :market_cap_usd, :rank, :volume_usd, :available_supply, :total_supply, :percent_change_1h, :percent_change_24h, :percent_change_7d, :update_time])
