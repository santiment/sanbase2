defmodule Sanbase.Signal.History.WalletTriggerHistory do
  @moduledoc """
  Implementation of historical_trigger_points for the generic wallet movement signal.
  Currently it is bucketed in `1 day` intervals and goes 90 days back.
  """

  alias Sanbase.Signal.Trigger.WalletTriggerSettings

  defimpl Sanbase.Signal.History, for: WalletTriggerSettings do
