defmodule Sanbase.Signal.Trigger.DailyMetricTriggerSettings do
  @moduledoc ~s"""
  ...
  alias Sanbase.Signal.Trigger.DailyMetricTriggerSettings

  defimpl Sanbase.Signal.Settings, for: DailyMetricTriggerSettings do
