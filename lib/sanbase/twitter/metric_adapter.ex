defmodule Sanbase.Twitter.MetricAdapter do
  ...
  @required_selectors Map.new(@metrics, &{&1, [[:slug]]})
  ...
  @impl Sanbase.Metric.Behaviour
  def timeseries_data_per_slug("twitter_followers", %{slug: [_ | _] = slugs}, from, to, interval, _opts) do
  ...
  def available_slugs do
    cache_key = Sanbase.Cache.hash({__MODULE__, :slugs_with_twitter_handle})
