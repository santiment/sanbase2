defmodule SanbaseWeb.Graphql.Complexity.TechIndicatorsComplexity do
  ...
  to access everything without limits.
  """
  def social_volume(_, _, %Absinthe.Complexity{context: %{auth: %{auth_method: :basic}}}) do
    0
  end
  ...
  For max complexity 5000 we allow 1000 values
  """
  def social_volume(%{from: from, to: to, interval: interval}, _child_complexity, _) do
    get_complexity(from, to, interval)
  end
  ...
  to access everything without limits.
  """
  def topic_search(_, _, %Absinthe.Complexity{context: %{auth: %{auth_method: :basic}}}) do
    0
  end
  ...
  For max complexity 5000 we allow 1000 values
  """
  def topic_search(%{from: from, to: to, interval: interval}, _child_complexity, _) do
    get_complexity(from, to, interval)
  end
