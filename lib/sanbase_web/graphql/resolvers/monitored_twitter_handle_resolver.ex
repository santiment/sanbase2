defmodule SanbaseWeb.Graphql.Resolvers.MonitoredTwitterHandleResolver do
  ...
  def add_twitter_handle_to_monitor(_root, %{twitter_handle: handle} = args, %{context: %{auth: %{current_user: user}}}) do
  ...
  def get_current_user_submitted_twitter_handles(_root, _args, %{context: %{auth: %{current_user: user}}}) do
