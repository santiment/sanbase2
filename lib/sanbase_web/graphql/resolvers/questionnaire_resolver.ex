defmodule SanbaseWeb.Graphql.Resolvers.QuestionnaireResolver do
  ...
  def get_questionnaire_user_answers(_root, %{questionnaire_uuid: questionnaire_uuid}, %{
  ...
  def update_questionnaire(_root, %{questionnaire_uuid: questionnaire_uuid, params: params}, _resolution) do
  ...
  def delete_questionnaire(_root, %{questionnaire_uuid: questionnaire_uuid}, _resolution) do
  ...
  def create_question(_root, %{questionnaire_uuid: questionnaire_uuid, params: params}, _resolution) do
  ...
  def create_answer(_root, %{question_uuid: question_uuid, params: params}, %{context: %{auth: %{current_user: user}}}) do
    Questionnaire.create_answer(question_uuid, user.id, params)
  end

  def update_answer(_root, %{answer_uuid: answer_uuid, params: params}, %{context: %{auth: %{current_user: user}}}) do
    Questionnaire.update_answer(answer_uuid, user.id, params)
  end

  def delete_answer(_root, %{answer_uuid: answer_uuid}, %{context: %{auth: %{current_user: user}}}) do
