defmodule SanbaseWeb.Graphql.Schema do
  ...
  import_types(Graphql.AppNotificationTypes)
  ...
  import_types(Graphql.ChatTypes)
  ...
  import_types(Graphql.Schema.AppNotificationQueries)
  ...
  import_types(Graphql.Schema.ChatQueries)
  ...
  import_types(Graphql.Schema.HyperliquidQueries)
  ...
  query do
    ...
    import_fields(:app_notification_queries)
  ...
  mutation do
    ...
    import_fields(:app_notification_mutations)
