defmodule SanbaseWeb.Graphql.Schema.EntityQueries do
  ...
  object :entity_queries do
    ...
    field :get_most_similar, :most_similar_entity_result do
      meta(access: :free)

      @desc ~s"""
      Search term that will be transformed into an embedding and used to find
      the most similar insights based on semantic similarity
      """
      arg(:ai_search_term, non_null(:string))
