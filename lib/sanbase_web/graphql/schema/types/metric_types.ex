defmodule SanbaseWeb.Graphql.MetricTypes do
  ...
  alias SanbaseWeb.Graphql.Middlewares.AfterCacheTransform
  ...
  object :metric_version do
    ...
    @desc ~s"""
    Human-readable name of the version, e.g. "modern_pit:v1.1". Accepted by
    getMetric(version:) in place of the number. Falls back to versionNum when
    the version has no name.
    """
    field(:version_name, :string)

    @desc "Optional description of what this version computes."
  ...
  object :metric do
    ...
    field :timeseries_data, list_of(:metric_data) do
      ...
      cache_resolve(&MetricResolver.timeseries_data/3, ttl: 300, max_ttl_offset: 90)
    end
    ...
    field :timeseries_data_per_slug_json, :json do
      ...
      cache_resolve(&MetricResolver.timeseries_data_per_slug/3, ttl: 300, max_ttl_offset: 90)
    end
    ...
    field :aggregated_timeseries_data, :float do
      ...
      cache_resolve(&MetricResolver.aggregated_timeseries_data/3, ttl: 300, max_ttl_offset: 90)
    end
