defmodule SanbaseWeb.Graphql.ProjectTypes do
  ...
  object :project do
    ...
    field :main_contract_address, :string do
      cache_resolve(&ProjectResolver.project_main_contract_address/3)
    end

    field :contract_addresses, list_of(:contract_address) do
      cache_resolve(&ProjectResolver.project_contract_addresses/3)
    end

    field :eth_addresses, list_of(:eth_address) do
      cache_resolve(&ProjectResolver.eth_addresses_resolver_fun/3)
    end
    ...
    field :tags, list_of(:project_tag) do
      cache_resolve(&ProjectResolver.project_market_segment_tags/3)
    end
