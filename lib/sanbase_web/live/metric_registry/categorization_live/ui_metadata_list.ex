    ...
    <tr id={"ui-metadata-#{@ui_metadata.id}"} data-id={@ui_metadata.id} class="hover:bg-gray-50">
      <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
        <.reorder_controls
          ...
          display_order={@ui_metadata.display_order_in_mapping || @index + 1}
        />
      </td>
      ...
      <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
        {@ui_metadata.chart_style || "line"}
      </td>
      <td class="px-2 py-4 whitespace-nowrap text-center">
        <.icon :if={@ui_metadata.show_on_sanbase} name="hero-eye" class="w-5 h-5 text-green-600" />
        <.icon
          :if={!@ui_metadata.show_on_sanbase}
          name="hero-eye-slash"
      ...
      <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
        <div class="flex space-x-2">
          <.link
            navigate={~p"/admin/metric_registry/categorization/ui_metadata/edit/#{@ui_metadata.id}"}
