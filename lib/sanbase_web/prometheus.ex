defmodule SanbaseWeb.Prometheus do
  @moduledoc """
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam
      # {Plugins.Phoenix, router: SanbaseWeb.Router, endpoint: SanbaseWeb.Endpoint},
      # Plugins.Ecto,
      # Plugins.Oban,
  ...
  def dashboards do
    [
      ...
      # {:sanbase, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
