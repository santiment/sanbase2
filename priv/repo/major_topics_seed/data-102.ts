export const NARRATIVES = {
  ...
  datasets: [
    ...
    },
    {
      label: 'NFL',
      infofi: false,
      topics: 'injury,nfl,patrick,patriots,eagles',
      description:
        "Based on the messages from twitter, key topics currently being discussed include injuries to key players such as Teddye Buchanan, Alvin Kamara, Javonte Williams, and Christian Watson. There is also discussion about the performance of certain NFL teams, such as the Miami Dolphins' playoff drought and the struggles of the Cleveland Browns. Additionally, there is speculation about the coaching situation for the Browns and the potential return of Patrick Mahomes from injury. The performance of certain quarterbacks, such as Phillip Rivers and the development of quarterbacks under Kevin Stefanski, is also a point of discussion. Finally, there is debate about potential coaching changes and predictions for upcoming NFL games.",
      data: [
        19, 12, 8, 8, 22, 6, 5, 9, 10, 9, 4, 5, 17, 11, 1, 22, 8, 5, 12, 13, 8, 7, 10, 9, 14, 3, 10,
        14, 12, 10, 4, 7, 8, 15, 5, 25, 9, 11, 4, 8, 26, 8, 9, 12, 9, 10, 11, 17, 12, 7, 8, 10, 15,
        9, 4,
      ],
    },
    {
      label: 'Solana Breakpoint',
      infofi: false,
      topics: 'breakpoint,solanaconf,booth,london,solflare',
      description:
        'The key topics discussed in the messages from twitter are related to the Breakpoint event organized by Solana. The event is described as a must-attend crypto conference, with mentions of Breakpoint London, Breakpoint NYC, and Breakpoint Abu Dhabi. Attendees share their experiences, such as meeting friends, attending presentations, and being inspired to host more events. The event is praised for its unique atmosphere, variety of activities, and community engagement. Additionally, there are mentions of specific activities and presentations at Breakpoint, such as SUPA AMM and the Firedancer on mainnet. Overall, the messages highlight the excitement and success of Breakpoint events and the positive impact they have on the Solana community.',
      data: [
        11, 4, 11, 9, 19, 47, 7, 7, 11, 11, 7, 16, 9, 4, 14, 9, 11, 11, 3, 5, 12, 14, 13, 7, 5, 1,
        10, 8, 10, 2, 13, 3, 3, 1, 4, 6, 4, 8, 7, 2, 6, 5, 5, 15, 10, 15, 11, 7, 5, 5, 7, 13, 9, 4,
        15,
      ],
    },
    {
