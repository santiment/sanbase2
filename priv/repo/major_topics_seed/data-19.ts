export const NARRATIVES = {
  ...
  datasets: [
    ...
    },
    {
      ...
      data: [
        66, 77, 51, 13, 2, 1, 16, 7, 16, 32, 24, 25, 13, 19, 8, 24, 10, 25, 20, 24, 26, 36, 26, 12,
        22, 15, 19, 23, 17, 13, 12, 18, 9, 40, 25, 34, 22, 23, 21, 19, 26, 20, 32, 20, 21, 15, 24,
        20, 18, 20, 15, 25, 21, 24, 24,
      ],
    },
    {
      label: 'BTC Price',
      topics: 'btc,price,break,range,resistance',
      description:
        "The key topics currently being discussed in the crypto industry on Twitter include the price movements of Bitcoin, potential resistance levels, bullish and bearish scenarios, market rally predictions, technical analysis indicators such as RSI and moving averages, and the impact of inflation rates and interest rate cuts on Bitcoin's price. Traders are closely monitoring support and resistance levels, as well as looking for signals of potential market trends. There is also discussion about the potential for Bitcoin to reach new highs and the importance of risk management in trading decisions. Overall, sentiment seems to be mixed with some expecting further increases in price while others are cautious about a possible decline.",
      data: [
        14, 5, 7, 9, 66, 88, 24, 35, 10, 16, 11, 14, 27, 8, 1, 9, 3, 19, 15, 11, 8, 8, 6, 21, 11, 7,
        6, 6, 5, 18, 10, 17, 6, 14, 9, 19, 3, 6, 33, 14, 24, 7, 11, 15, 11, 13, 29, 12, 10, 9, 6,
        28, 11, 15, 11,
      ],
    },
    {
