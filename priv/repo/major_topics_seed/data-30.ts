export const NARRATIVES = {
  ...
  datasets: [
    ...
    },
    {
      ...
      description:
        'The key topics currently discussed in the crypto community on social media include meme tokens, meme coins, influencers earning low income, upcoming meme coin launches, potential meme coin investments, and partnerships between animated cat brands and meme coins. The community is excited about the potential of meme coins and the opportunity to make fast money. Some specific meme tokens mentioned are $AIOZ, $WELSH, $STX, $BTC, $bober, $BRETT, $PEPE, $WOLF, $FLOKI, $SPURDO, $SHIB, $PEIPEI, $NPC, and $FROG. There is also discussion about the new META token $FROGGY and the partnership between Simonscat and RealFlokiInu for a memecoin launch. Overall, the community is enthusiastic about the meme coin market and the potential for significant gains.',
      data: [
        7, 6, 7, 3, 2, 2, 1, 13, 8, 6, 4, 6, 5, 8, 9, 3, 2, 11, 4, 14, 6, 10, 8, 10, 6, 6, 7, 9, 2,
        6, 37, 29, 5, 10, 5, 11, 6, 1, 3, 2, 6, 5, 5, 5, 2, 6, 7, 8, 4, 5, 9, 2, 3, 8, 8,
      ],
    },
    {
      label: 'ETFs',
      topics: 'etfs,etf,net,grayscale,spot',
      description:
        'The key topics currently being discussed on Twitter in relation to the crypto industry are Ethereum ETFs, Bitcoin ETFs, capital rotation from BTC to ETH in ETFs, Grayscale Ethereum Trust, spot Ethereum ETF outflows, complexity of Ethereum and the SEC, Ethereum ETF launch driving inflows, Grayscale offloading BTC, FOMC meeting impact on ETF approval, ETF trading volume comparison between Ethereum and Bitcoin, Grayscale burning through their ETH stack, Mt. Gox supply hitting the market, and Crypto ETF flow analysis.',
      data: [
        6, 2, 5, 6, 13, 11, 7, 5, 3, 1, 4, 1, 14, 6, 3, 32, 48, 4, 12, 0, 3, 9, 3, 7, 13, 9, 2, 9,
        1, 2, 2, 3, 9, 5, 8, 1, 5, 1, 3, 3, 3, 3, 12, 6, 38, 4, 3, 2, 9, 1, 0, 1, 3, 6, 6,
      ],
    },
    {
      label: 'Kamala Harris',
      topics: 'kamala,harris,election,party,vote',
      description:
        "The messages from Twitter suggest that there is a lot of discussion surrounding the crypto industry and its relationship with political figures, particularly Kamala Harris. There are mentions of potential shifts in Silicon Valley due to the change from Biden to Harris, as well as calls for Harris to distance herself from certain organizations. Additionally, there are discussions about the Democratic Party's stance on Bitcoin and cryptocurrency, with some suggesting that there is a growing wing within the party that wants to be more pro-crypto. Overall, it seems that there is a lot of interest and debate within the crypto community about political figures and their impact on the industry.",
      data: [
        5, 6, 2, 5, 5, 2, 2, 2, 10, 5, 4, 7, 7, 11, 2, 20, 1, 2, 5, 5, 14, 7, 5, 2, 4, 4, 8, 6, 9,
        8, 5, 2, 11, 1, 13, 7, 20, 8, 6, 9, 8, 6, 4, 1, 4, 8, 8, 16, 5, 5, 12, 5, 15, 7, 4,
      ],
    },
    {
      label: 'SOL',
      topics: 'solana,sol,ethereum,eth,fees',
      description:
        "The key topics currently being discussed on Twitter regarding Solana include:\n- Solana's recent price dip and investors buying more during the dip\n- Comparison between Solana and Ethereum, with Solana outshining Ethereum in terms of trading volume\n- Solana's market cap being 1/5th of Ethereum's\n- Analyst predictions on Solana's future price trajectory\n- Solana ecosystem funding rebounding after a bear market\n- Solana's performance in 2024, with over 166% gains from the yearly low\n- Solana's meme token launch platform surpassing Ethereum in daily revenue\n- Solana's potential for growth and future market cap increase\n- Solana ETF spot filing potentially leading to a price increase\n- Solana projects raising significant funding in Q2, reaching a two-year high\n\nOverall, the sentiment on Twitter seems to be bullish on Solana, with many investors optimistic about its future potential and growth.",
      data: [
        5, 8, 7, 6, 1, 4, 1, 5, 3, 4, 2, 9, 3, 3, 4, 8, 5, 3, 4, 3, 1, 10, 4, 4, 6, 8, 4, 8, 3, 3,
        4, 4, 5, 3, 15, 10, 6, 13, 2, 5, 7, 7, 6, 28, 5, 3, 10, 8, 8, 5, 2, 3, 2, 10, 2,
      ],
    },
    {
      label: 'DOGE',
      topics: 'dogecoin,doge,nfts,baby,floor',
      description:
        "The key topics currently discussed in the messages from Twitter about the crypto industry, specifically Dogecoin, include:\n- Dogecoin holders being deep thinkers and passionate about the cryptocurrency\n- Dogecoin being referred to as a religion by some individuals\n- Speculation about Dogecoin's price dropping below ten cents for potential investment opportunities\n- Excitement about the potential for Dogecoin to increase in value\n- Mention of NASA's Perseverance rover potentially finding evidence of ancient microbial activity on Mars\n- Promotion of a pet-related product with a discount code\n- Reference to the number 69 in relation to Dogecoin volume on a trading platform\n\nOverall, the messages reflect a mix of humor, speculation, excitement, and promotion within the crypto community, particularly focused on Dogecoin and potential developments in the industry.",
      data: [
        2, 2, 4, 2, 0, 0, 2, 6, 1, 4, 4, 0, 1, 1, 37, 5, 3, 5, 8, 4, 9, 3, 2, 1, 2, 5, 5, 11, 3, 4,
        8, 4, 4, 3, 1, 7, 4, 1, 3, 2, 3, 3, 9, 5, 3, 3, 2, 5, 1, 0, 3, 0, 1, 2, 3,
      ],
    },
    {
      label: 'GameFi',
      topics: 'game,gaming,games,web3,play',
      description:
        'The key topics currently discussed in the crypto industry on social media include gaming meta, Forgotten Runes Spritesheets, Wanderers game launch on Epic games, Hollywood video game performers planning to strike, investing in gaming, AI and Blockchain convergence in gaming, Otherworld Official metaverse, Skullish game, and Little Lemons x Nifty Game Night. There is also a mention of playing K-K more aggressively than A-A in poker. The community is encouraged to check out various gaming-related events, launches, and opportunities for investment in the gaming industry.',
      data: [
        6, 1, 5, 5, 0, 0, 4, 3, 5, 1, 2, 2, 3, 4, 2, 4, 3, 4, 2, 37, 5, 4, 0, 3, 5, 1, 4, 9, 3, 2,
        0, 4, 0, 3, 9, 1, 12, 1, 8, 2, 3, 1, 2, 3, 2, 3, 5, 1, 1, 0, 2, 2, 8, 5, 5,
      ],
    },
    {
      label: 'US Government 2B BTC movement',
      topics: 'government,reserve,strategic,governments,govt',
      description:
        "The key topic currently being discussed on Twitter is the US government's movement of a large amount of Bitcoin, totaling $2 billion, to an unknown wallet. This has sparked speculation and debate among users, with some suggesting that Bitcoin is the only option for the US to pay off its national debt. Others are questioning the motives behind the government's actions and the implications for the cryptocurrency market. Overall, there is a mix of excitement, skepticism, and curiosity surrounding the US government's involvement with Bitcoin.",
      data: [
        4, 1, 2, 1, 4, 9, 7, 1, 2, 1, 3, 1, 0, 0, 2, 0, 0, 5, 3, 2, 2, 41, 3, 5, 3, 0, 3, 1, 1, 1,
        2, 2, 7, 7, 2, 1, 2, 1, 0, 0, 2, 5, 8, 1, 1, 12, 1, 3, 0, 2, 1, 0, 1, 1, 6,
      ],
    },
    {
      label: 'Art',
      topics: 'art,artists,making,life,thread',
      description:
        'The key topic discussed in the messages from twitter is art, specifically different forms of art such as tulle art, digital art, wood burning art, and the process of art. The messages also mention artists such as Benjamin Shine, Ngo Van Sac, and dy_yifanzhang. Additionally, there is a mention of a meme contest related to art and a specific art exhibition called "Tranquil Resilience" for ArtgumiDAO. The messages also touch upon the theme of art as a career and the success of an eBay business compared to an art career.',
      data: [
        0, 3, 35, 4, 0, 1, 4, 3, 1, 1, 2, 6, 1, 5, 2, 4, 1, 11, 4, 7, 2, 2, 3, 1, 1, 2, 3, 1, 2, 4,
        4, 0, 6, 3, 5, 7, 1, 1, 4, 0, 4, 1, 3, 2, 2, 2, 1, 2, 1, 0, 2, 1, 2, 2, 3,
      ],
    },
    {
      label: 'Dip',
      topics: 'dip,short,long,bull,buy',
      description:
        'The key topics discussed in the messages from Twitter about the crypto industry include:\n1. Market sentiment and price action analysis\n2. Strategies for trading in the crypto market, such as identifying momentum and setting targets\n3. The importance of risk management and staying in the game after selling a stock\n4. The volatility of the Bitcoin bull market and the need to hodl through it\n5. Long positions in Bitcoin and potential target levels\n6. The use of technical analysis and chart patterns in trading\n7. The impact of macroeconomic factors on crypto trading\n8. The role of market makers in influencing price movements\n9. The need for patience and discipline in trading\n10. The potential risks and rewards of investing in cryptocurrencies.',
      data: [
        2, 1, 2, 3, 3, 0, 0, 18, 2, 3, 4, 3, 1, 8, 3, 2, 2, 4, 2, 7, 5, 6, 3, 4, 0, 0, 5, 0, 2, 3,
        5, 2, 2, 2, 0, 2, 3, 1, 4, 4, 2, 4, 7, 6, 1, 6, 9, 4, 2, 4, 0, 0, 3, 0, 1,
      ],
    },
    {
      label: 'ETH 9th birthday',
      topics: 'happy,ethereum,9th,years,decade',
      description:
        "The key topics discussed in the messages from twitter about Ethereum include:\n- Celebrating Ethereum's birthday\n- Recognition of Ethereum's achievements and growth\n- Mention of key figures like Vitalik Buterin\n- Discussion of Ethereum's future and focus on building applications\n- Comparison with other blockchain projects like Ergo Platform\n- Personal experiences and career growth related to Ethereum\n- Mention of specific Ethereum-related projects like Polymarket and Ethverse\n- Mention of events like EDCON2024 and BitwiseInvest NYSE closing bell event\n- Mention of Ethereum-related artwork and community activities\n\nOverall, the messages reflect a positive sentiment towards Ethereum and its impact on the crypto industry.",
      data: [
        4, 0, 0, 3, 0, 1, 0, 0, 10, 4, 6, 0, 3, 4, 2, 4, 15, 2, 2, 2, 0, 0, 43, 1, 1, 0, 5, 4, 2, 1,
        0, 1, 1, 0, 1, 0, 0, 2, 2, 0, 1, 0, 2, 1, 0, 1, 2, 2, 13, 1, 1, 0, 0, 1, 11,
      ],
    },
    {
      label: 'NEIRO',
      topics: 'neiro,doge,dog,shib,listing',
      description:
        'The key topics discussed in the messages from Twitter about the crypto industry include:\n- Discussion about the cryptocurrency $NEIRO and its potential for growth\n- Comparison of $NEIRO to other popular cryptocurrencies like $DOGE\n- Speculation about $NEIRO reaching a market cap of $500m-$1b\n- Announcement of $NEIRO being listed on a new exchange\n- Mention of $NEIRO draining liquidity from other memecoins\n- Introduction of new cryptocurrencies like $COLON and their relation to existing ones like $DOGE\n- Launch of new meme coins like Poo Chi (SIR) and their upcoming listing on LATOKEN\n\nOverall, the messages reflect a mix of excitement, speculation, and analysis surrounding various cryptocurrencies in the market.',
      data: [
        1, 2, 1, 1, 0, 2, 0, 3, 4, 1, 5, 0, 0, 1, 2, 0, 1, 2, 2, 3, 3, 1, 2, 3, 0, 2, 1, 1, 6, 5, 3,
        3, 2, 7, 1, 0, 2, 1, 0, 2, 0, 1, 2, 3, 2, 1, 4, 1, 4, 5, 1, 2, 3, 2, 3,
      ],
    },
    {
      label: 'Senator Lummis & Bitcoin strategic reserve',
      topics: 'lummis,reserve,strategic,purchase,debt',
      description:
        "The key topic being discussed on Twitter is the proposal by US Senator Cynthia Lummis to establish a strategic Bitcoin reserve for the United States. The proposal involves buying 1 million bitcoins over 5 years to potentially reduce the nation's debt. The initiative would not create new debt and would be funded by reallocating existing funds within the Federal Reserve System and Treasury Department. The announcement has generated both support and criticism, with some seeing it as a game-changer and others questioning the motives behind it. Senator Lummis' plan has sparked conversations about the potential impact on the crypto industry and the broader financial landscape.",
      data: [
        0, 7, 1, 0, 2, 2, 8, 1, 1, 0, 2, 2, 0, 0, 3, 3, 0, 0, 0, 0, 0, 0, 1, 2, 3, 9, 2, 1, 3, 2, 0,
        0, 1, 2, 3, 0, 2, 20, 2, 0, 1, 2, 1, 0, 2, 1, 0, 1, 0, 0, 0, 0, 1, 1, 2,
      ],
    },
    {
      label: 'Bitcoin Nashville',
      topics: 'nashville,conference,speakers,bitcoin,bitcoin2024',
      description:
