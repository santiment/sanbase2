export const NARRATIVES = {
  ...
  datasets: [
    {
      label: 'BTC Price',
      topics: 'btc,range,90k,bitcoin,100k',
      description:
        "The key topic discussed in the messages from Twitter is the current price movement of Bitcoin ($BTC). Traders and analysts are expressing concern over the recent drop in price below $88K and the potential for further downside. Some are predicting a possible drop to $78K to close a CME gap, while others are noting the low volatility and undervalued conditions of Bitcoin. On-chain signals and technical indicators are also being closely monitored, with some suggesting a bearish outlook if certain support levels are breached. Overall, there is a sense of caution and uncertainty surrounding the future direction of Bitcoin's price.",
      data: [
        10, 4, 8, 16, 100, 86, 28, 47, 9, 9, 12, 27, 13, 31, 13, 40, 7, 9, 31, 16, 12, 25, 6, 25,
        22, 14, 4, 8, 15, 29, 31, 12, 9, 18, 10, 14, 24, 35, 17, 22, 15, 10, 11, 25, 7, 22, 20, 25,
        16, 20, 12, 11, 22, 6, 12,
      ],
    },
    {
      label: 'BTC',
      topics: 'bitcoin,money,fiat,understand,currency',
      description:
        "Based on the messages from Twitter, the key topics currently being discussed in the crypto industry include:\n1. Bitcoin Central Bank issues\n2. Peer-to-peer, non-state money effectiveness\n3. Kamala Harris\n4. Bitcoin class and its origins\n5. Energy and climate issues related to Bitcoin\n6. Bull Flag Target\n7. Trading lemonade for Bitcoin\n8. Litecoin halving\n9. Bitcoin ownership and design\n10. Bitcoin's strong persistence\n11. Physics of Bitcoin\n12. Quantum computing and Bitcoin\n13. Crypto games and wallets\n14. Mainframe Blockchain\n\nThese topics reflect a diverse range of discussions and opinions within the crypto community on Twitter.",
      data: [
        18, 8, 11, 22, 122, 58, 10, 19, 7, 16, 16, 20, 14, 10, 11, 14, 24, 16, 16, 22, 12, 13, 12,
        12, 10, 21, 20, 15, 14, 13, 13, 11, 10, 20, 22, 9, 23, 16, 11, 19, 23, 18, 19, 17, 19, 18,
        28, 21, 17, 12, 10, 11, 21, 11, 15,
      ],
    },
    {
      label: 'AI',
    ...
    },
    {
      ...
      data: [
        0, 0, 3, 2, 1, 4, 1, 35, 3, 2, 3, 0, 4, 2, 13, 0, 3, 0, 3, 1, 3, 4, 4, 5, 4, 1, 0, 2, 1, 4,
        0, 0, 2, 1, 3, 7, 3, 2, 2, 1, 3, 2, 1, 4, 3, 2, 2, 3, 4, 3, 2, 1, 1, 2, 2,
      ],
    },
  ],
}
