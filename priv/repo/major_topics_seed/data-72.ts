export const NARRATIVES = {
  ...
  datasets: [
    ...
    },
    {
      ...
      description:
        'The crypto community on Twitter is buzzing with discussions about meme coins and their potential for explosive growth. Key words such as "memecoin," "meme of the week," "meme line held," "Chad Marco meme," "Bitcoin breaks ATH," "4CHAN," "Meme Super Cycle," "SHIB," and "Memetorrent community" are being mentioned frequently. There is a sense of excitement and anticipation for the future of meme coins and their impact on the crypto industry. Investors are keeping a close eye on these developments as they anticipate a potential rally in meme coins.',
      data: [
        9, 6, 4, 5, 5, 4, 4, 4, 5, 13, 1, 5, 8, 5, 6, 5, 5, 7, 10, 8, 4, 7, 11, 5, 3, 4, 3, 4, 5, 6,
        14, 17, 77, 7, 3, 3, 6, 5, 7, 14, 2, 4, 5, 6, 3, 13, 3, 11, 13, 1, 8, 4, 9, 5, 2,
      ],
    },
    {
      label: 'Coinbase ',
      topics: 'coinbase,breach,data,kyc,customer',
      description:
        "The key topics discussed in the messages from Twitter about Coinbase and crypto industry include:\n1. Coinbase hack and data breach\n2. Concerns about security and protection of user data\n3. Scams and phishing attempts targeting crypto users\n4. Extortion attempts and bribery of staff\n5. Criticisms of Coinbase's customer service and handling of security incidents\n6. Recommendations for increased security measures, such as gun ownership for protecting crypto assets\n7. Crypto detective involvement in tracking hackers and stolen funds\n8. Stories of individuals being scammed out of large sums of crypto\n9. Promotion of new crypto projects like $FEG token with claims of combating scams and rug pulls\n\nOverall, the messages highlight the ongoing challenges and risks in the crypto industry, as well as the importance of vigilance and security measures for protecting digital assets.",
      data: [
        8, 3, 1, 10, 2, 1, 3, 11, 3, 3, 9, 31, 8, 18, 5, 4, 3, 12, 13, 10, 8, 6, 12, 10, 3, 9, 3, 6,
        8, 3, 3, 8, 3, 2, 9, 3, 7, 2, 5, 6, 10, 11, 14, 6, 4, 4, 6, 6, 4, 1, 3, 4, 10, 2, 7,
      ],
    },
    {
      label: 'SUI',
      topics: 'sui,sei,dex,hack,suinetwork',
      description:
        "The key topics currently being discussed in the crypto industry on Twitter include:\n1. SUI stablecoin market cap hitting $1B ATH and doubling in just 2 months.\n2. Discussion about SUI withdrawals being disabled on centralized exchanges due to the Cetus hack.\n3. Speculation about buying the USDC depeg on SUI after the Cetus hack.\n4. The popularity of Ikachan NFTs on SUI.\n5. Sei Blockchain shifting to an EVM-only future and ditching Cosmos support.\n6. Updates on the CETUS team addressing a bug in their oracle.\n7. Bullish sentiment towards SUI Network and Cetus Protocol.\n8. Introduction of Sei Giga as a blockchain superhighway with breakthrough technology.\n9. Talks about scaling blockchains and the uniqueness of Sei Giga's multi-proposer setup.\n10. Upcoming projects and partnerships involving SUI, including a SUI-native game and a fair launch platform with Cetus Protocol.\n11. Launch of SUI market on TokenPocket for easy swapping of SUI-based tokens.",
      data: [
        4, 6, 8, 5, 6, 0, 1, 15, 8, 11, 3, 4, 8, 5, 6, 9, 6, 3, 7, 4, 7, 3, 11, 6, 6, 5, 6, 2, 7, 3,
        11, 9, 4, 6, 6, 4, 3, 4, 21, 6, 4, 2, 8, 5, 1, 10, 8, 7, 5, 3, 4, 6, 7, 6, 3,
      ],
    },
    {
      label: 'Whales',
      topics: 'whale,position,whales,long,james',
      description:
        "The key topic discussed in the messages from Twitter is the activity of a Bitcoin whale who has been increasing their long position significantly, reaching amounts of hundreds of millions of dollars. The whale is making substantial profits and there is speculation about what they may know that others don't. Additionally, there is mention of a hacker's wallet with inflated values and the movement of Ethereum whales sending mixed signals. There is also discussion about Dogecoin whales dumping a large amount of DOGE and the potential impact on the price. Overall, the focus is on the actions of large players in the crypto industry and the potential implications for the market.",
      data: [
        4, 2, 0, 2, 6, 3, 11, 33, 24, 12, 4, 0, 0, 3, 0, 3, 2, 1, 0, 1, 2, 1, 2, 1, 1, 16, 4, 1, 2,
        3, 2, 6, 2, 2, 3, 7, 1, 3, 3, 3, 1, 3, 2, 6, 2, 0, 1, 5, 1, 1, 1, 11, 3, 53, 2,
      ],
    },
    {
      label: 'GameFi',
