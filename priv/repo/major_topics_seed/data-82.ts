export const NARRATIVES = {
  ...
  datasets: [
    {
      label: 'AI',
      topics: 'ai,agents,agent,chatgpt,theoriqai',
      description:
        "The key topics discussed in the messages from twitter are:\n1. AI-generated images and NFT creation\n2. GPT-5 and its capabilities\n3. Monitoring user behavior and psychology using AI\n4. AR technology and its potential for merging perceptions and actions\n5. DALPY project and its goal of enabling direct NFT creation with AI\n6. ArcBlock's announcement of three new AI tools\n7. Horizon Alpha model hosted on OpenRouterAI\n8. AethirCloud's decentralized GPU cloud infrastructure platform\n9. Human-AI collaboration in NFINIT Labs V2\n10. Strategy-as-Content System in NFINIT Labs V2",
      data: [
        60, 172, 34, 16, 7, 4, 12, 25, 19, 42, 26, 37, 22, 18, 13, 22, 21, 26, 23, 32, 25, 22, 33,
        22, 45, 35, 34, 24, 17, 27, 23, 31, 33, 18, 41, 17, 21, 33, 14, 34, 33, 30, 18, 26, 30, 20,
        36, 59, 25, 26, 26, 23, 25, 27, 19,
      ],
    },
    {
      label: 'ETH price',
      topics: '4000,eth,4k,ethereum,break',
      description:
        'The key topics currently being discussed in the crypto industry on Twitter include:\n- Ethereum\'s price potential, with predictions of reaching $4,000 soon\n- Support levels for Ethereum at $2,400-$2,800\n- Ethereum\'s potential to reach $5,000\n- ETH/BTC hitting 6 month highs\n- Ethereum\'s role in stablecoins and DeFi, potentially driving institutional demand\n- Positive sentiment towards Ethereum, with mentions of it being "giga bullish" and "mechanically controlled"\n- Speculation on the potential for Ethereum to outperform other altcoins\n- Comparison of Ethereum to Bitcoin in terms of potential growth and adoption\n\nOverall, the sentiment towards Ethereum appears to be positive, with many users expressing confidence in its future performance and potential for growth.',
      data: [
        16, 3, 13, 7, 0, 8, 18, 10, 8, 13, 9, 6, 7, 7, 11, 31, 86, 15, 11, 4, 12, 8, 6, 28, 11, 6,
        7, 9, 17, 19, 13, 3, 13, 8, 5, 9, 9, 15, 14, 11, 7, 7, 8, 13, 8, 9, 15, 13, 6, 3, 6, 12, 15,
        13, 9,
      ],
    },
    {
      label: 'Importance of Bitcoin',
      topics: 'fiat,bitcoin,money,understand,bitcoiners',
      description:
        'The messages from twitter about Bitcoin discuss various topics such as the benefits of hodling Bitcoin, the comparison between Bitcoin and traditional investments, the misunderstanding of Bitcoin by experts in finance and economics, the perception of volatility in Bitcoin, the association of Bitcoin with crime, the true value of Bitcoin as a global currency, the psychology of Bitcoin holders, the difference in investment approach between fiat currency and Bitcoin, and the importance of securing Bitcoin with titanium seed phrase backups. Overall, the messages highlight the unique characteristics and potential of Bitcoin as a revolutionary financial asset.',
      data: [
        4, 2, 3, 9, 61, 26, 1, 9, 8, 3, 8, 13, 8, 8, 7, 4, 4, 10, 12, 2, 7, 11, 5, 8, 13, 7, 11, 9,
        7, 6, 9, 9, 7, 1, 15, 28, 10, 9, 1, 9, 14, 10, 8, 8, 6, 13, 5, 13, 7, 7, 13, 7, 7, 3, 7,
      ],
    },
    {
      label: 'ETH 10 year anniversary',
      topics: 'birthday,happy,10th,ethereum,10',
      description:
        "The key topics currently being discussed on Twitter regarding Ethereum's 10th birthday include:\n- Celebrating Ethereum's 10th anniversary\n- Ethereum's goals for the next 10 years\n- The evolution of Ethereum from smart contracts to NFTs and DeFi\n- The excitement and anticipation for the next 10 years of Ethereum\n- Personal experiences and reflections on Ethereum's journey\n- Speculation and trading activities related to Ethereum and other cryptocurrencies\n\nOverall, the sentiment towards Ethereum seems positive and optimistic, with many users expressing their love for the platform and excitement for its future developments.",
      data: [
        6, 0, 2, 11, 2, 6, 1, 3, 17, 5, 5, 6, 8, 13, 2, 4, 65, 3, 3, 9, 2, 5, 142, 2, 3, 5, 2, 1, 2,
        1, 1, 5, 1, 1, 4, 4, 1, 1, 2, 3, 2, 0, 2, 4, 3, 2, 5, 7, 21, 3, 8, 1, 5, 2, 60,
      ],
    },
    {
      label: 'BTC price',
      topics: 'range,btc,115k,zone,bitcoin',
      description:
        'Based on the messages from Twitter, it is clear that the key topics being discussed in the crypto community include the current price of Bitcoin ($BTC) hovering around $118,000-$122,300, with predictions of a potential retest above $140,000 in the near future. There is also mention of altcoins experiencing a downturn while Bitcoin remains relatively stable. Analysts are bullish on Bitcoin as long as it stays above key levels such as $115,000 and $123,000, with targets set at $130,000 and potentially $155,200. Institutional accumulation is driving a bullish outlook for the next 90 days, with predictions ranging from $125,000-$180,000. Overall, there is a mix of optimism and caution in the community regarding the future price movements of Bitcoin.',
      data: [
        6, 4, 6, 12, 61, 14, 17, 13, 2, 10, 5, 3, 4, 4, 6, 3, 2, 3, 10, 1, 10, 3, 4, 20, 5, 4, 6, 8,
        4, 10, 6, 0, 4, 0, 6, 2, 13, 12, 10, 16, 6, 14, 2, 11, 8, 10, 12, 6, 4, 2, 3, 10, 5, 4, 3,
      ],
    },
    {
      label: 'Gaming',
    ...
    },
    {
      ...
      data: [
        4, 1, 2, 1, 0, 3, 2, 3, 3, 2, 1, 1, 2, 7, 0, 4, 4, 5, 6, 1, 3, 3, 3, 0, 1, 8, 6, 1, 5, 2, 2,
        4, 2, 1, 4, 0, 5, 4, 0, 5, 2, 0, 2, 0, 2, 4, 0, 1, 1, 3, 2, 2, 3, 4, 1,
      ],
    },
    {
      label: 'BTFD',
      topics: 'dip,cro,hype,bonk,sui',
      description:
        'Based on the messages from Twitter, it seems that the key topic being discussed is buying the dip in the crypto market. Many users are expressing their opinions on buying the dip for various cryptocurrencies such as $BTC, $ETH, $SHIB, and others. Some users are optimistic about the market continuing in a bull trend, while others are frustrated with the current downward trend and hoping for a reversal soon. There is also discussion about the importance of patience and holding onto evergreen tickers like Nasdaq420. Additionally, there are warnings about the proliferation of new cryptocurrencies and the potential negative impact on existing coins through dilution. Overall, the sentiment seems to be mixed with some users advocating for buying the dip and others expressing caution or frustration.',
      data: [
        1, 0, 1, 2, 0, 3, 3, 21, 5, 0, 0, 4, 1, 9, 10, 0, 1, 3, 0, 0, 4, 2, 3, 2, 2, 1, 2, 2, 0, 3,
        4, 5, 0, 0, 4, 5, 1, 3, 1, 1, 1, 2, 3, 3, 2, 4, 4, 1, 2, 0, 1, 0, 2, 1, 1,
      ],
    },
    {
      label: 'Stablecoins',
      topics: 'stablecoins,stablecoin,stable,genius,act',
      description:
        'The key topics discussed in the messages from twitter about the crypto industry include stablecoins, their volume and usage, the potential future of stablecoins in traditional finance, the introduction of new stablecoins like AUSD and Wyoming Stable Token, the growth of the stablecoin market, and the integration of stablecoins in cross-border currency exchange. There is also mention of the GENIUS Act laying the foundation for a more secure stablecoin future and the use of stablecoins on different blockchain platforms like Core and Bitcoin. Overall, stablecoins are seen as a significant part of the crypto industry with potential for further growth and integration into traditional finance.',
      data: [
        1, 2, 1, 3, 0, 1, 0, 1, 1, 2, 2, 1, 1, 3, 0, 2, 3, 1, 0, 1, 3, 2, 0, 2, 2, 6, 1, 1, 2, 1, 4,
        1, 2, 4, 1, 3, 0, 0, 0, 2, 1, 4, 3, 0, 33, 3, 2, 1, 5, 5, 2, 3, 3, 1, 2,
      ],
    },
  ],
}
