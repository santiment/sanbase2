export const NARRATIVES = {
  ...
  datasets: [
    ...
    },
    {
      ...
      description:
        'The key topics discussed in the messages from twitter are about supporting artists by buying tokens, bidding on their art, and the importance of recognizing the creation date of artwork. The messages also touch on the democratization of art and the impact of technology on the art industry. Overall, the messages emphasize the value of authenticity and the need for artists to be paid for their work.',
      data: [
        3, 7, 32, 2, 3, 5, 4, 1, 2, 3, 7, 1, 0, 6, 2, 5, 1, 2, 3, 2, 10, 3, 2, 4, 0, 2, 1, 5, 0, 4,
        2, 4, 7, 3, 6, 7, 1, 1, 1, 7, 2, 4, 5, 2, 7, 1, 4, 4, 5, 2, 1, 5, 4, 5, 2,
      ],
    },
    {
      label: 'Gold price',
      topics: 'gold,silver,platinum,prices,4000',
      description:
