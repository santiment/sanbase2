export const NARRATIVES = {
  ...
  datasets: [
    ...
    },
    {
      ...
      data: [
        11, 3, 3, 9, 4, 3, 3, 2, 2, 5, 5, 1, 4, 1, 3, 2, 2, 2, 2, 5, 2, 1, 6, 3, 5, 3, 11, 4, 4, 0,
        1, 7, 2, 4, 4, 4, 1, 4, 4, 1, 1, 1, 1, 1, 0, 4, 3, 6, 4, 1, 4, 3, 5, 5, 90,
      ],
    },
    {
      label: 'Klout platform',
      infofi: true,
      topics: 'klout,kloutgg,hashtag,influence,measurable',
      description:
        'The key topic currently being discussed in the messages from twitter is the rise of Klout (@kloutgg) as a platform for trading attention as a valuable asset. Klout is described as a prediction market built on Solana where users can turn their social influence, likes, comments, and trends into tradable assets. The platform rewards awareness and early trend spotting, allowing users to capitalize on emerging viral waves. Klout is seen as the future of on-chain reputation and a way for early adopters to win big in the crypto industry. The platform is praised for its gamified engagement, seamless DeFi integration, and real utility in tracking social influence. Users are encouraged to connect their Twitter accounts to Klout to start earning Klout scores and participating in trend markets and hashtag NFTs. Overall, Klout is portrayed as a revolutionary platform that is transforming social media attention into a valuable currency in the Web3 era.',
      data: [
        3, 3, 3, 13, 2, 1, 4, 6, 1, 2, 8, 6, 1, 2, 3, 4, 5, 3, 10, 0, 3, 7, 4, 10, 9, 4, 6, 4, 4,
        10, 2, 1, 9, 7, 7, 5, 2, 6, 2, 4, 1, 3, 3, 4, 7, 4, 5, 7, 7, 16, 7, 2, 5, 3, 0,
      ],
    },
    {
      label: 'RWA',
      infofi: false,
      topics: 'rwa,rwas,tokenizing,tokenization,realworld',
      description:
        'The messages from twitter highlight the growing trend of Real World Asset (RWA) tokenization in the crypto industry. Key points mentioned include the adoption of RWA tokenization at a trillion-dollar scale, the top blockchains hosting billions in tokenized assets, the importance of tokenizing assets for increased distribution and liquidity, and the potential for RWA tokenization to unlock a $40 trillion on-chain lending market.\n\nAdditionally, the messages discuss the need for a scalable RWA tokenization model, the deployment of RWA infrastructure, and the significance of institutions understanding and adopting RWAs. The potential for RWA tokenization to bring real-world assets on-chain, the importance of seamless and institution-grade liquidity, and the impact of deRWA tokens are also highlighted.\n\nOverall, the messages emphasize the increasing importance and potential of RWA tokenization in the crypto industry, with various projects and initiatives focused on advancing this technology.',
      data: [
        3, 3, 8, 4, 5, 10, 7, 3, 4, 2, 2, 1, 8, 5, 3, 9, 3, 6, 0, 3, 3, 3, 4, 2, 5, 8, 2, 8, 1, 8,
        2, 2, 11, 3, 2, 3, 8, 9, 12, 1, 5, 8, 4, 4, 5, 6, 3, 3, 11, 3, 6, 3, 1, 5, 5,
      ],
    },
    {
      label: 'Israel - Palestine',
      infofi: false,
      topics: 'israeli,israel,netanyahu,bodies,ministry',
      description:
        'The messages from twitter are not related to the crypto industry. They mainly focus on the ongoing conflict between Israel and Palestine, with updates on Israeli military actions, Palestinian casualties, and UN warnings about the situation in Gaza and the West Bank. The messages also mention Israeli settler attacks, arrests of Palestinians, and the passing of a bill authorizing the execution of Palestinian detainees. The situation is described as grim, with concerns about shelter conditions in Gaza and the potential for a low-level insurgency.',
      data: [
        3, 5, 9, 5, 0, 5, 1, 7, 5, 5, 0, 6, 8, 5, 8, 1, 13, 3, 1, 1, 5, 2, 6, 6, 6, 5, 2, 1, 1, 6,
        6, 4, 4, 3, 8, 6, 3, 1, 8, 15, 14, 4, 13, 8, 2, 2, 3, 2, 3, 5, 0, 1, 4, 1, 2,
      ],
    },
    {
      label: 'Tariff stimulus checks',
      infofi: false,
      topics: 'dividend,tariff,2000,stimulus,tariffs',
      description:
        "The messages from twitter are discussing President Trump's announcement of a $2,000 stimulus check for Americans, funded by U.S. tariff revenues. Some are speculating that the stimulus could come in the form of tax cuts or stablecoins instead of cash. There is excitement in the market, with predictions of a bull run and potential impacts on inflation and cryptocurrency prices. Some are skeptical of the plan, suggesting it could lead to inflation and benefit lower-income individuals more. Overall, the announcement is seen as a potential boost for high-risk assets like cryptocurrencies.",
      data: [
        1, 4, 35, 3, 4, 2, 5, 6, 11, 2, 3, 4, 6, 1, 3, 2, 1, 2, 10, 3, 1, 5, 1, 1, 4, 2, 4, 3, 0, 3,
        1, 6, 2, 0, 6, 4, 2, 10, 6, 4, 26, 3, 0, 2, 13, 3, 14, 5, 0, 2, 0, 4, 3, 0, 1,
      ],
    },
  ],
}
