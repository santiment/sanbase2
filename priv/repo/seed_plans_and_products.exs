...
INSERT INTO plans (id, name, product_id, amount, currency, interval, "order") VALUES
  ...
  (14,'ENTERPRISE',2,0,'USD','month',7),
  (202,'PRO',2,52900,'USD','year',6),
  (17,'ENTERPRISE',2,0,'USD','year',5),
  (12,'BASIC',2,1100,'USD','month',4),
  (13,'PRO',2,5100,'USD','month',3),
  (15,'BASIC',2,10800,'USD','year',2),
  (16,'PRO',2,54000,'USD','year',1),
