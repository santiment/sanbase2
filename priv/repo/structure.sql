...
CREATE TABLE public.sign_up_trials (
    ...
    sent_3day_email boolean DEFAULT false,
    sent_11day_email boolean DEFAULT false,
    sent_end_trial_email boolean DEFAULT false,
    inserted_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL
);
...
CREATE INDEX sign_up_trials_user_id_index ON public.sign_up_trials USING btree (user_id);
