...
--
-- Name: cmc_project; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cmc_project (
    id bigint NOT NULL,
    project_id bigint NOT NULL,
    logos_uploaded_at timestamp without time zone,
...
--
-- Name: cmc_project_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.cmc_project_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: cmc_project_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.cmc_project_id_seq OWNED BY public.cmc_project.id;
...
--
-- Name: cmc_project id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cmc_project ALTER COLUMN id SET DEFAULT nextval('public.cmc_project_id_seq'::regclass);
...
--
-- Name: cmc_project cmc_project_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cmc_project
    ADD CONSTRAINT cmc_project_pkey PRIMARY KEY (id);
...
--
-- Name: cmc_project_project_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX cmc_project_project_id_index ON public.cmc_project USING btree (project_id);
...
--
-- Name: cmc_project cmc_project_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cmc_project
    ADD CONSTRAINT cmc_project_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.project(id) ON DELETE CASCADE;
