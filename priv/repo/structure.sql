...
--
-- Name: exchanges_name_index; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX exchanges_name_index ON public.exchanges USING btree (name);
