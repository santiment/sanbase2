...
ALTER SEQUENCE public.exchange_eth_addresses_id_seq OWNED BY public.exchange_addresses.id;
...
ALTER TABLE ONLY public.exchange_addresses ALTER COLUMN id SET DEFAULT nextval('public.exchange_eth_addresses_id_seq'::regclass);
...
--
-- Name: exchange_addresses exchange_eth_addresses_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
CREATE UNIQUE INDEX exchange_eth_addresses_address_index ON public.exchange_addresses USING btree (address);
...
--
-- Name: exchange_addresses exchange_eth_addresses_infrastructure_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
