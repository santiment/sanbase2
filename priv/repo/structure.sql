...
CREATE TABLE public.user_settings (
    id bigint NOT NULL,
    user_id bigint NOT NULL,
    signal_notify_email boolean DEFAULT false,
    signal_notify_telegram boolean DEFAULT false,
