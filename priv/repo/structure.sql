...
CREATE TABLE public.exchange_market_pair_mappings (
    ...
    market_pair character varying(255),
    from_ticker character varying(255),
    to_ticker character varying(255),
    from_slug character varying(255),
    to_slug character varying(255),
