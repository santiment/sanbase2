...
--
-- Name: timeline_event_likes; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.timeline_event_likes (
    id bigint NOT NULL,
...
--
-- Name: timeline_event_likes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.timeline_event_likes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: timeline_event_likes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.timeline_event_likes_id_seq OWNED BY public.timeline_event_likes.id;
...
--
-- Name: timeline_event_likes id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.timeline_event_likes ALTER COLUMN id SET DEFAULT nextval('public.timeline_event_likes_id_seq'::regclass);
...
--
-- Name: timeline_event_likes timeline_event_likes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.timeline_event_likes
    ADD CONSTRAINT timeline_event_likes_pkey PRIMARY KEY (id);
...
--
-- Name: timeline_event_likes_timeline_event_id_user_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX timeline_event_likes_timeline_event_id_user_id_index ON public.timeline_event_likes USING btree (timeline_event_id, user_id);
...
--
-- Name: timeline_event_likes timeline_event_likes_timeline_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.timeline_event_likes
    ADD CONSTRAINT timeline_event_likes_timeline_event_id_fkey FOREIGN KEY (timeline_event_id) REFERENCES public.timeline_events(id);


--
-- Name: timeline_event_likes timeline_event_likes_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.timeline_event_likes
    ADD CONSTRAINT timeline_event_likes_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
