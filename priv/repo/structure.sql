...
--
-- Name: signal-cooldowns; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."signal-cooldowns" (
    id bigint NOT NULL,
    signal character varying(255) NOT NULL,
    who_triggered character varying(255) NOT NULL,
    last_triggered timestamp without time zone
);


--
-- Name: signal-cooldowns_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public."signal-cooldowns_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: signal-cooldowns_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public."signal-cooldowns_id_seq" OWNED BY public."signal-cooldowns".id;
...
--
-- Name: signal-cooldowns id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."signal-cooldowns" ALTER COLUMN id SET DEFAULT nextval('public."signal-cooldowns_id_seq"'::regclass);
...
--
-- Name: signal-cooldowns signal-cooldowns_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."signal-cooldowns"
    ADD CONSTRAINT "signal-cooldowns_pkey" PRIMARY KEY (id);
