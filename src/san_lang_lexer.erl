...
-module(san_lang_lexer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("src/san_lang_lexer.xrl", 33).
...
-file("src/san_lang_lexer.erl", 321).
yystate() -> 22.
...
yystate(22, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 100 ->
    yystate(10, Ics, Line, Tlen+1, Action, Alen);
yystate(22, [C|Ics], Line, Tlen, Action, Alen) when C >= 103, C =< 122 ->
    yystate(10, Ics, Line, Tlen+1, Action, Alen);
...
yystate(12, [10|Ics], Line, Tlen, _, _) ->
    yystate(20, Ics, Line+1, Tlen+1, 10, Tlen);
...
-file("src/san_lang_lexer.xrl", 11).
yyaction_0(TokenLine) ->
     { token, { '+', TokenLine } } .

-compile({inline,yyaction_1/1}).
-file("src/san_lang_lexer.xrl", 12).
yyaction_1(TokenLine) ->
     { token, { '-', TokenLine } } .

-compile({inline,yyaction_2/1}).
-file("src/san_lang_lexer.xrl", 13).
yyaction_2(TokenLine) ->
     { token, { '*', TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("src/san_lang_lexer.xrl", 14).
yyaction_3(TokenLine) ->
     { token, { '/', TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("src/san_lang_lexer.xrl", 15).
yyaction_4(TokenLine) ->
     { token, { '(', TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("src/san_lang_lexer.xrl", 16).
yyaction_5(TokenLine) ->
     { token, { ')', TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("src/san_lang_lexer.xrl", 17).
yyaction_6(TokenLine) ->
     { token, { '[', TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("src/san_lang_lexer.xrl", 18).
yyaction_7(TokenLine) ->
     { token, { ']', TokenLine } } .

-compile({inline,yyaction_8/1}).
-file("src/san_lang_lexer.xrl", 19).
yyaction_8(TokenLine) ->
     { token, { '->', TokenLine } } .

-compile({inline,yyaction_9/1}).
-file("src/san_lang_lexer.xrl", 20).
yyaction_9(TokenLine) ->
     { token, { ',', TokenLine } } .

-compile({inline,yyaction_10/1}).
-file("src/san_lang_lexer.xrl", 21).
yyaction_10(TokenLine) ->
     { token, { '"', TokenLine } } .

-compile({inline,yyaction_11/1}).
-file("src/san_lang_lexer.xrl", 22).
yyaction_11(TokenLine) ->
     { token, { fn, TokenLine } } .

-compile({inline,yyaction_12/1}).
-file("src/san_lang_lexer.xrl", 23).
yyaction_12(TokenLine) ->
     { token, { 'end', TokenLine } } .

-compile({inline,yyaction_13/2}).
-file("src/san_lang_lexer.xrl", 24).
yyaction_13(TokenChars, TokenLine) ->
     { token, { env_var, TokenLine, to_binary (TokenChars) } } .

-compile({inline,yyaction_14/2}).
-file("src/san_lang_lexer.xrl", 25).
yyaction_14(TokenChars, TokenLine) ->
     { token, { ascii_string, TokenLine, strip_quoted_ascii_string (TokenChars) } } .

-compile({inline,yyaction_15/2}).
-file("src/san_lang_lexer.xrl", 26).
yyaction_15(TokenChars, TokenLine) ->
     { token, { identifier, TokenLine, to_binary (TokenChars) } } .

-compile({inline,yyaction_16/2}).
-file("src/san_lang_lexer.xrl", 27).
yyaction_16(TokenChars, TokenLine) ->
     { token, { float, TokenLine, to_float (TokenChars) } } .

-compile({inline,yyaction_17/2}).
-file("src/san_lang_lexer.xrl", 28).
yyaction_17(TokenChars, TokenLine) ->
     { token, { int, TokenLine, to_integer (TokenChars) } } .

-compile({inline,yyaction_18/0}).
-file("src/san_lang_lexer.xrl", 29).
yyaction_18() ->
     skip_token .
