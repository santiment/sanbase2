...
-file("src/san_lang_lexer.xrl", 30).
...
yystate(25, Ics, Line, Tlen, _, _) ->
    {12,Tlen,Ics,Line,25};
yystate(24, [85|Ics], Line, Tlen, Action, Alen) ->
...
yystate(22, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 33 ->
    yystate(30, Ics, Line, Tlen+1, 10, Tlen);
yystate(22, [C|Ics], Line, Tlen, _, _) when C >= 35 ->
    yystate(30, Ics, Line, Tlen+1, 10, Tlen);
...
yystate(16, [67|Ics], Line, Tlen, Action, Alen) ->
...
-file("src/san_lang_lexer.xrl", 9).
yyaction_0(TokenLine) ->
     { token, { '+', TokenLine } } .

-compile({inline,yyaction_1/1}).
-file("src/san_lang_lexer.xrl", 10).
yyaction_1(TokenLine) ->
     { token, { '-', TokenLine } } .
