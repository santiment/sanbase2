  ...
  test "restricted metrics", %{metrics_access_map: access_map} do
    ...
    expected_restricted_metrics =
      [
        ...
        "social_dominance_youtube_1h_moving_average",
        "social_dominance_youtube_24h_moving_average",
        ...
        "sentiment_volume_consumed_youtube",
