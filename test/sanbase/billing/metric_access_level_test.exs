  ...
  test "restricted metrics", %{metrics_access_map: access_map} do
    ...
    expected_restricted_metrics =
      [
        ...
        # stack age band metrics
        "stack_age_bands_0_to_1d",
        "stack_age_bands_1d_to_7d",
        "stack_age_bands_7d_to_1m",
        "stack_age_bands_1m_to_3m",
        "stack_age_bands_3m_to_6m",
        "stack_age_bands_6m_to_1y",
        "stack_age_bands_1y_to_2y",
        "stack_age_bands_2y_to_3y",
        "stack_age_bands_3y_to_5y",
        "stack_age_bands_5y_to_7y",
        "stack_age_bands_7y_to_10y",
        "stack_age_bands_10y_to_inf",
        "percent_of_stack_age_bands_0_to_1d",
        "percent_of_stack_age_bands_1d_to_7d",
        "percent_of_stack_age_bands_7d_to_1m",
        "percent_of_stack_age_bands_1m_to_3m",
        "percent_of_stack_age_bands_3m_to_6m",
        "percent_of_stack_age_bands_6m_to_1y",
        "percent_of_stack_age_bands_1y_to_2y",
        "percent_of_stack_age_bands_2y_to_3y",
        "percent_of_stack_age_bands_3y_to_5y",
        "percent_of_stack_age_bands_5y_to_7y",
        "percent_of_stack_age_bands_7y_to_10y",
        "percent_of_stack_age_bands_10y_to_inf",
        # hodl waves metrics
        "hodl_waves_0_to_1d",
        "hodl_waves_1d_to_7d",
        "hodl_waves_7d_to_1m",
        ...
        "hodl_waves_2y_to_3y",
        "hodl_waves_3y_to_5y",
        "hodl_waves_5y_to_10y",
        "hodl_waves_10y_to_20y",
        # ETH2 metrics
        "eth2_stakers_count",
        "eth2_roi",
        # Defi
