  ...
  test "restricted metrics", %{metric_access_map: access_map} do
    ...
    expected_restricted_metrics =
      [
        ...
        "social_dominance_chan_1h_moving_average",
        "social_dominance_chan_24h_moving_average",
        ...
        "sentiment_volume_consumed_chan",
