  ...
  test "restricted metrics", %{metrics_access_map: access_map} do
    ...
    expected_restricted_metrics =
      [
        ...
        "age_bands_5y_to_7y",
        "age_bands_7y_to_10y",
        "age_bands_10y_to_inf",
        "percent_of_age_bands_0_to_1d",
        "percent_of_age_bands_1d_to_7d",
        "percent_of_age_bands_7d_to_1m",
        "percent_of_age_bands_1m_to_3m",
        "percent_of_age_bands_3m_to_6m",
        "percent_of_age_bands_6m_to_1y",
        "percent_of_age_bands_1y_to_2y",
        "percent_of_age_bands_2y_to_3y",
        "percent_of_age_bands_3y_to_5y",
        "percent_of_age_bands_5y_to_7y",
        "percent_of_age_bands_7y_to_10y",
        "percent_of_age_bands_10y_to_inf",
        # hodl waves metrics
        "hodl_waves_0_to_1d",
        "hodl_waves_1d_to_7d",
        "hodl_waves_7d_to_1m",
