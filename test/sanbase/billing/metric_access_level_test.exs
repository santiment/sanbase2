  ...
  test "restricted metrics", %{metric_access_map: access_map} do
    ...
    expected_restricted_metrics =
      [
        ...
        # sentiment_ratio metrics
        "sentiment_positive_ratio",
        "sentiment_positive_ratio_1h",
        "sentiment_positive_ratio_1d",
        "sentiment_neutral_ratio",
        "sentiment_neutral_ratio_1h",
        "sentiment_neutral_ratio_1d",
        "sentiment_negative_ratio",
        "sentiment_negative_ratio_1h",
        "sentiment_negative_ratio_1d",
