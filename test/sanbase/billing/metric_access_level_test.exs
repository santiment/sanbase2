  ...
  test "restricted metrics", %{metrics_access_map: access_map} do
    ...
    expected_restricted_metrics =
      [
        ...
        "social_dominance_discord_avg",
        "social_dominance_professional_traders_chat_avg",
        "social_dominance_reddit_avg",
        "social_dominance_telegram_avg",
        "social_dominance_bitcointalk_avg",
        "social_dominance_twitter_avg",
        "social_dominance_total_avg",
