  ...
  test "restricted metrics", %{metrics_access_map: access_map} do
    ...
    expected_restricted_metrics =
      [
        ...
        "social_dominance_total_1h",
        "social_dominance_total_24h",
        ...
        "social_dominance_total_1h_change_1d",
        "social_dominance_total_1h_change_7d",
        "social_dominance_total_1h_change_30d",
        "social_dominance_total_24h_change_1d",
        "social_dominance_total_24h_change_7d",
        "social_dominance_total_24h_change_30d",
