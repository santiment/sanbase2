  ...
  describe "subscription meta" do
    ...
    test "restricted clickhouse v2 queries" do
      ...
      aliases = [
        ...
        "mvrv_usd",
        "token_age_consumed",
        "token_circulation_10y",
        "token_circulation_180d",
        "token_circulation_1d",
        "token_circulation_20y",
        "token_circulation_2y",
        "token_circulation_30d",
        "token_circulation_365d",
        "token_circulation_3y",
        "token_circulation_5y",
        "token_circulation_60d",
        "token_circulation_7d",
        "token_circulation_90d",
        "mean_age_days",
