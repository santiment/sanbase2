defmodule Sanbase.Clickhouse.DailyActiveAddresses.Erc20DailyActiveAddressesTest do
  ...
  test "returns active addresses with deposits share for given period and contract in chunks",
       context do
    with_mock Sanbase.ClickhouseRepo,
      query: fn _, _ ->
        {:ok,
      ...
      result =
        Erc20DailyActiveAddresses.average_active_addresses_with_deposits(
          context.contract1,
          context.from,
          context.to,
          "1d"
