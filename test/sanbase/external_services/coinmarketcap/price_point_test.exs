defmodule Sanbase.ExternalServices.Coinmarketcap.PricePointTest do
  ...
  test "converting price point to measurement for BTC", %{
  ...
  test "converting price point to measurement for USD", %{
    price_point: price_point,
    expectation: expectation
  } do
  ...
  test "converting price point to measurement for USD when price_usd is missing", %{
    price_point: price_point,
    expectation: expectation
  } do
