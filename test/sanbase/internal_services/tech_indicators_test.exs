  ...
  test "fetch price_volume_diff", _context do
    mock(
      ...
      {:ok,
       %HTTPoison.Response{
         body:
           "[{\"price_volume_diff\": 0.0, \"timestamp\": 1516406400}, {\"price_volume_diff\": -0.014954423076923185, \"timestamp\": 1516492800}, {\"price_volume_diff\": -0.02373337292856359, \"timestamp\": 1516579200}, {\"price_volume_diff\": -0.030529013702074614, \"timestamp\": 1516665600}, {\"price_volume_diff\": -0.0239400614928722, \"timestamp\": 1516752000}]",
         status_code: 200
       }}
    )
