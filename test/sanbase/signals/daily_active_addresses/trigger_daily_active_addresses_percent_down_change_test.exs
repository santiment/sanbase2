defmodule Sanbase.Signal.DailyActiveAddressesPercentDownChangeTest do
  ...
  test "get_data works properly", _context do
    data =
      {:ok,
       [
    ...
    Sanbase.Mock.prepare_mock2(&Sanbase.Clickhouse.MetricAdapter.timeseries_data/6, data)
