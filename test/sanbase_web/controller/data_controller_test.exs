defmodule SanbaseWeb.DataControllerTest do
  ...
  setup do
    update_time = NaiveDateTime.utc_now(:second)
    ...
    p1 =
      ...
      |> update_latest_coinmarketcap_data(%{rank: 20}, update_time)
    ...
    %{p1: p1, p2: p2, p3: p3, update_time: update_time}
  end
      ...
      cond do
        project.id == context.p1.id ->
          %{
            ...
            "rank" => 20,
            "rank_updated_at" =>
              DateTime.from_naive!(context.update_time, "Etc/UTC") |> DateTime.to_iso8601(),
  ...
  defp update_latest_coinmarketcap_data(project, args, update_time) do
