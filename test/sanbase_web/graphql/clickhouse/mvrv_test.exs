defmodule SanbaseWeb.Graphql.MVRVApiTest do
  ...
  test "when no interval is provided", context do
    ...
    with_mocks([
      ...
      trx_volumes = result["data"]["mvrvRatio"]

      assert trx_volumes == [
               %{"datetime" => "2017-05-13T00:00:00Z", "ratio" => 100},
               %{"datetime" => "2017-05-14T00:00:00Z", "ratio" => 200},
               %{"datetime" => "2017-05-15T00:00:00Z", "ratio" => 300}
             ]
    end
  end
