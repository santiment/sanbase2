defmodule SanbaseWeb.Graphql.ExchangesTest do
  ...
  setup do
    insert(:exchange_address, %{address: "0x234", name: "Binance"})
    insert(:exchange_address, %{address: "0x567", name: "Bitfinex"})
    insert(:exchange_address, %{address: "0x789", name: "Binance"})
